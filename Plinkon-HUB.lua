...
MainTab:AddParagraph("NOTICE!", "To reset the Invisibility, reset the character")
...
ScriptTab:AddParagraph("NOTICE!","Dark DEX and Orca Hub do not work on Script-Ware. I do not have a fix for Orca Hub. But for Dark DEX, go into Infinite Yeild and execute the DEX original script and it should work")